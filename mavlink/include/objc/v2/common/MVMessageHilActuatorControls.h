...
- (id)initWithSystemId:(uint8_t)systemId componentId:(uint8_t)componentId timeUsec:(uint64_t)timeUsec controls:(float *)controls mode:(MAV_MODE)mode flags:(uint64_t)flags;
