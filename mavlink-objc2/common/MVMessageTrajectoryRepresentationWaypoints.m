...
- (NSString *)description {
  return [NSString stringWithFormat:@"%@, timeUsec=%lld, validPoints=%d, posX=%@, posY=%@, posZ=%@, velX=%@, velY=%@, velZ=%@, accX=%@, accY=%@, accZ=%@, posYaw=%@, velYaw=%@", [super description], [self timeUsec], [self validPoints], @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]", @"[array of float[5]]"];
}
